...
// //             <Link to="/" className='list-none' ><MenuItem onClick={handleMenuClose}>Logout</MenuItem></Link>
// //           </Menu>
// //         </Toolbar>
...
// //             <Typography variant="h6" style={{ color: 'black', marginBottom: '16px' ,marginLeft:'25px', font:'bold',fontWeight:'200px'}}>
// //               Admin Dashboard
// //             </Typography>
...
// import React from 'react';
// import { AppBar, Toolbar, Typography, IconButton, Drawer, List, ListItem, ListItemText, Menu, MenuItem, Divider,Avatar} from '@mui/material';
// import MenuIcon from '@mui/icons-material/Menu';
// import AccountCircle from '@mui/icons-material/AccountCircle';
// import UserIcon from '@mui/icons-material/People';
// import CourseIcon from '@mui/icons-material/Book';
...
//           >
//             <MenuItem onClick={handleMenuClose}>Profile</MenuItem>
//             <Link to="/signin" className='list-none'><MenuItem onClick={handleMenuClose}>Logout</MenuItem></Link>
//           </Menu>
//         </Toolbar>
//       </AppBar>
//       <nav>
...
//             <Divider style={{ marginBottom: '16px' }} />
//             <List>
//               <ListItem button onClick={() => handleSectionChange('user-management')} style={{ marginBottom: '16px', display: 'flex', alignItems: 'center',hover:'gray',borderBottom:'black' }}>
//                 <UserIcon style={{ marginRight: drawerOpen ? '16px' : '0' }} />
//                 {drawerOpen && <ListItemText primary="User Management" />}
//               </ListItem>
//               <Divider style={{ marginBottom: '16px' }} />
          ...
          <div style={{ width: drawerWidth, padding: '16px', backgroundColor: 'white' }}>
            ...
            <List>
              {/* <ListItem
                ...
                style={{ marginBottom: '16px', display: 'flex', alignItems: 'center', borderBottom: '2px solid black', color: 'black' }}
              >
                <MenuIcon style={{ marginRight: drawerOpen ? '16px' : '0' }} />
                {drawerOpen && <ListItemText primary="Admin Dashboard" />}
              </ListItem> */}
              <Divider style={{ marginBottom: '16px' }} />
              <ListItem
                button
                onClick={() => handleSectionChange('user-management')}
                style={{ marginBottom: '16px', display: 'flex', alignItems: 'center', borderBottom: '1px solid black', color: 'black' }}
              >
                <UserIcon style={{ marginRight: drawerOpen ? '16px' : '0' }} />
                {drawerOpen && <ListItemText primary="User Management" />}
              </ListItem>
              ...
              <ListItem
                button
                onClick={() => handleSectionChange('syllabus-management')}
                style={{ marginBottom: '16px', display: 'flex', alignItems: 'center', borderBottom: '1px solid black', color: 'black' }}
              >
                <SyllabusIcon style={{ marginRight: drawerOpen ? '16px' : '0' }} />
                {drawerOpen && <ListItemText primary="Syllabus Management" />}
              ...
              <ListItem
                button
                onClick={() => handleSectionChange('test-management')}
                style={{ marginBottom: '16px', display: 'flex', alignItems: 'center', borderBottom: '1px solid black', color: 'black' }}
              >
                <TestIcon style={{ marginRight: drawerOpen ? '16px' : '0' }} />
                {drawerOpen && <ListItemText primary="Test Management" />}
              ...
              <ListItem
                ...
                style={{ display: 'flex', alignItems: 'center', borderBottom: '1px solid black', color: 'black' }}
              >
                <AccountCircle style={{ marginRight: drawerOpen ? '16px' : '0' }} />
